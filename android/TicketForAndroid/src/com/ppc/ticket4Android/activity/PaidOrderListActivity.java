...
public class PaidOrderListActivity extends Activity{
	ListView list;
	...
	public void init(){
		...
		topText.setText("已完成订单");
		
		list = (ListView) findViewById(R.id.paid_order_listview);
		listItemAdapter= new SimpleAdapter(this,listItem,//数据源 
	        ...
	        list.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1,
					   ...
					   intent.setClass(PaidOrderListActivity.this,PaidOrderDetialActivity.class);
	...
	Handler mHandler = new Handler(){
		public void handleMessage(Message msg){
			switch (msg.what) {
			case 1:
				Toast.makeText(PaidOrderListActivity.this,"服务器连接异常！", Toast.LENGTH_SHORT).show();
				break;
