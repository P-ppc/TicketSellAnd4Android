...
<script type="text/javascript" src="js/ticketGet.js?time="></script>
...
<body>
  ...
  <input id="name" type="hidden" value='${sessionScope.worker.name}'/>
   ...
   <div id="ticketGetTb">
     ...
     <table>
       <tr>
        ...
        <td>&nbsp;乘客姓名：<input type="text" id="passengerNameQuery" style="width:90px"/></td>
        <td>&nbsp;乘客证件号：<input type="text" id="passengerIdQuery" style="width:90px"/>&nbsp;</td>
   ...
   <div id="orderInfo" icon="icon-save"
	...
	<table width="90%" height="70%" border="1px" style="margin: auto" cellpadding="0" cellspacing="0">
